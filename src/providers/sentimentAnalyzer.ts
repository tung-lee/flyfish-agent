...
export class SentimentAnalyzer {
    ...
    private negativeWords = [
        "bearish", "dump", "crash", "dead", "loss", "down", "low", "bad", 
        "terrible", "awful", "horrible", "sad", "hate", "📉", "selling", 
        "bear", "lost", "manipulated",
        "fuck you", "stfu", "shut up", "shut the fuck up", "stupid bot", 
        "dumb bot", "idiot", "stop", "please shut up", "shut up please",
        "dont talk", "silence", "stop talking", "be quiet", "hush", "wtf", 
        "chill", "stop responding", "god damn it", "god damn", "goddamnit", 
        "can you not", "can you stop", "hate you", "hate this", "fuck up"
    ];
